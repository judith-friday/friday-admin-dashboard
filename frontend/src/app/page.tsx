...
export default function MessageDashboard() {
  ...
  return (
    <div className="h-[100dvh] flex flex-col overflow-hidden" data-pwa-shell style={{background: '#0d1117', color: '#f1f5f9', paddingTop: 'env(safe-area-inset-top, 0px)', paddingBottom: 0}}>
